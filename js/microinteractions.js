const addToLunchboxBtn = document.querySelector(".add-to-lunchbox-btn");
const addToLunchboxLabel = addToLunchboxBtn
  ? addToLunchboxBtn.querySelector(".btn-label")
  : null;
...
function initialize() {
  if (!addToLunchboxBtn || !addToLunchboxLabel) return;
  setPlainLabel(addToLunchboxLabel, defaultText);
  addToLunchboxBtn.addEventListener("click", () =>
    onClick(addToLunchboxBtn, addToLunchboxLabel),
  );
}
